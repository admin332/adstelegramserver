...
Автор канала напишет пост по вашему брифу и пришлёт на проверку.

⏰ <b>Важно:</b> После получения черновика у вас будет 24 часа на проверку. Если не ответите — 70% вернётся вам, 30% получит автор за проделанную работу.

📝 <b>Лимит доработок:</b> максимум 3 правки.`;
